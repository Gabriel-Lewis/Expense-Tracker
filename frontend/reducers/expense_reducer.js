...
export default function(state = INITIAL_STATE, action) {
  ...
  switch (action.type) {
    ...
    case FETCH_EXPENSES_ERRORS:
      ...
      return { ...state, expenses: [], error, loading: false };
    ...
    case FETCH_EXPENSE_ERRORS:
      error = action.payload || { message: action.payload.message };
      return { ...state, activeExpense: null, error, loading: false };
    ...
    case CREATE_EXPENSE_ERRORS:
      error = action.payload || { message: action.payload.message };
  	return { ...state, newExpense: null, error, loading: false };
    ...
    case DELETE_EXPENSE_ERRORS:
      error = action.payload || { message: action.payload.message };
  	return { deletedExpense: null, error, loading: false };
