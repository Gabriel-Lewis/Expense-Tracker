...
export default function(state = INITIAL_STATE, action) {
  ...
  switch (action.type) {
    ...
    case FETCH_REPORTS_ERRORS:
      ...
      return { ...state, reportsList: [], error, loading: false };
    ...
    case FETCH_REPORT_ERRORS:
      error = action.payload || { message: action.payload.message };
      return { ...state, activeReport: null, error, loading: false };
    ...
    case CREATE_REPORT_ERRORS:
      error = action.payload || { message: action.payload.message };
  	return { ...state, newReport: null, error, loading: false };
    ...
    case DELETE_REPORT_ERRORS:
      error = action.payload || { message: action.payload.message };
  	return { ...state, deletedReport: null, error, loading: false };
